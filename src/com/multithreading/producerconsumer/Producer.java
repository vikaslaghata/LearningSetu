...
public class Producer implements Runnable {
    ...
    private boolean running = false; // volatile is not require, because this variable is not share b/w objects.
    ...
    private Message generateMessage() {
        Message message = new Message(idSequence.incrementAndGet(), Math.random()); //TODO: from java 7 ThreadLocalRandom.current().nextInt(min, max + 1) can be used.
